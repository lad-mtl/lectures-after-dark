...
interface UpcomingEventsRedesignProps {
    title?: string;
    subtitle?: string;
}

export const UpcomingEventsRedesign = ({
    title = "UPCOMING EVENTS",
    subtitle = "Curated nights for the curious mind.",
}: UpcomingEventsRedesignProps) => {
...
const UpcomingEventsRedesignSettings = () => {
        ...
        <div className="space-y-4">
            <div>
                ...
                <input
                    type="text"
                    value={title || ''}
                    onChange={(e) => setProp((props: UpcomingEventsRedesignProps) => props.title = e.target.value)}
            ...
            <div>
                ...
                <input
                    type="text"
                    value={subtitle || ''}
                    onChange={(e) => setProp((props: UpcomingEventsRedesignProps) => props.subtitle = e.target.value)}
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md"
                />
            </div>
        </div>
...
(UpcomingEventsRedesign as any).craft = {
    props: {
        title: "UPCOMING EVENTS",
        subtitle: "Curated nights for the curious mind.",
    },
    related: {
        settings: UpcomingEventsRedesignSettings
    }
};

export default UpcomingEventsRedesign;
